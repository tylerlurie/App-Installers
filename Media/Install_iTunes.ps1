...
Start-Process msiexec.exe -Wait -ArgumentList "/i AppleMobileDeviceSupport64.msi /qn"
Start-Process msiexec.exe -Wait -ArgumentList "/i iTunes64.msi REBOOT=ReallySuppress /qn"
